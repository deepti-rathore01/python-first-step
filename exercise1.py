...
if choice == 'add':print a+b
if choice == 'sub':print a-b
if choice == 'div':print a/b
if choice == 'multiplication':print a*b
if choice == 'mod':print a%b
if choice == 'exponent':print a**b
